...
class UpdateAllBooksTask(ActionBookGeneralPlugin):
    """
    ...
    def create_task(self, db_session: Session, args):
        ...
        for book in interleaved_books:
            if processor_filter == '*' or processor_filter == book.processor:
                results.append(
                    DownloadBookTask("GetBook", f'Updating: {book.name}', book.id, self.processors,
...
class UpdateSingleBookTask(ActionBookSpecificPlugin):
    """
